...
def makeSCTImageArray(pixels_vector,peaks_vector,image_mode,scale_factor,img_dtype,dim_order):
    ...
    for event in source:
        if event.mc.energy.value > 10 and len(event.r0.tels_with_data) >= 3:
            ...
            for tel_id in event.r0.tels_with_data:
                ...
                #print(max(image))
                #print(image)
                image_array = makeSCTImageArray(image,None,'PIXELS_3C',2,IMG_DTYPE,'channels_last')
