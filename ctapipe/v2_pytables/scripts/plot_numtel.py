...
source_temp = hessio_event_source("gamma_20deg_180deg_run655___cta-prod3-lapalma-2147m-LaPalma-SCT_cone10.simtel.gz",max_events=1)
...
source = hessio_event_source("gamma_20deg_180deg_run655___cta-prod3-lapalma-2147m-LaPalma-SCT_cone10.simtel.gz")
...
bins_dict = pkl.load(open("./aux/bins_cuts_dict/bins_cuts_dict_1bin.pkl", "rb" ))
...
print("Mean number of triggered telescopes (all) : {}".format(np.mean(trig_nums_list)))
print("Mean number of triggered telescopes (pasing) : {}".format(np.mean(passing_trig_nums_list)))
